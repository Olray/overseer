...
uses
  Forms,
  fDebug in 'fDebug.pas' {frmDebugger},
  fDbgOpt in 'fDbgOpt.pas' {frmOptions},
  uDbgHnd in 'uDbgHnd.pas',
  uDbgMsg in 'uDbgMsg.pas',
  Udbglb in '..\Lib\Udbglb.pas',
  uDbg in '..\Lib\uDbg.pas',
  uDbgIntf in '..\Lib\uDbgIntf.pas',
